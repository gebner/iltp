Propositional part of the ILTP-v1.1.1-Library
---------------------------------------------
...
Unpack and untar ILTP-v1.1.1-prop.tar.gz
> tar -xzf ILTP-v1.1.1-prop.tar.gz
This will create the directory ILTP-v1.1.1-prop.
