%--------------------------------------------------------------------------
% File     : SET669+3 : ILTP v1.1.0
% Domain   : Set Theory (Relations)
% Problem  : Id on Y subset of R  => Y subset of domain R & Y is range R
% Version  : [Wor89] axioms : Reduced > Incomplete.
% English  : If the identity relation on Y is a subset of a relation R from 
%            X to Y then Y is a subset of the domain of R and Y is the range 
%            of R.

% Refs     : [ILF] The ILF Group (1998), The ILF System: A Tool for the Int
%          : [Wor89] Woronowicz (1989), Relations Defined on Sets
% Source   : [ILF]
% Names    : RELSET_1 (32) [Wor89]

% Status   : Theorem
% Rating   : 0.27 v3.1.0, 0.22 v2.7.0, 0.17 v2.6.0, 0.29 v2.5.0, 0.38 v2.4.0, 0.25 v2.3.0, 0.33 v2.2.1
%
% Status (intuit.) : Open
