...
% Source   : [SFH92]
% Names    : ft5.2 : Ft benchmark formulae (pred.) (1992)
%
...
%--------------------------------------------------------------------------
fof(con,conjecture,(
( ! [X0] : ( ? [X1] : ( ? [X2] : ( ? [X3] : ( ? [X4] : ( ? [X5] : ( ? [X6] : ( ? [X7] : ( ? [X8] : ( ? [X9] : ( ? [X10] : ( p(X1, X2, X3, X4, X5, X6, X7, X8, X9, X10) <=> p(f(X0, X0), f(X1, X1), f(X2, X2), f(X3, X3), f(X4, X4), f(X5, X5), f(X6, X6), f(X7, X7), f(X8, X8), f(X9, X9))) ))))))))))) 
)).
