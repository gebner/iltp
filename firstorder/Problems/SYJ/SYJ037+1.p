...
%--------------------------------------------------------------------------
fof(axiom1,axiom,(
q(a1, a2, a3, a4, a5, a1, a2, a3, a4, a5))).

fof(con,conjecture,(
( ? [X1] : ( ? [X2] : ( ? [X3] : ( ? [X4] : ( ? [X5] : ( ? [Y1] : ( ? [Y2] : ( ? [Y3] : ( ? [Y4] : ( ? [Y5] : ( ( ( p(X1) & ( p(X2) & ( p(X3) & ( p(X4) & p(X5) ) ) ) ) <=> ( p(Y1) & ( p(Y2) & ( p(Y3) & ( p(Y4) & p(Y5) ) ) ) ))  & q(X1, X2, X3, X4, X5, Y1, Y2, Y3, Y4, Y5) )))))))))))
)).
