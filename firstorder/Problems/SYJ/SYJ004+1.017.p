...
fof(con,conjecture,(
? [X] : append(cons(a1,cons(a2,cons(a3,cons(a4,cons(a5,cons(a6,cons(a7,cons(a8,cons(a9,cons(a10,cons(a11,cons(a12,cons(a13,cons(a14,cons(a15,cons(a16,cons(a17,nil))))))))))))))))),nil,X)
)).
