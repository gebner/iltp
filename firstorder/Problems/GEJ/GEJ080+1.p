%--------------------------------------------------------------------------
% File     : GEJ080+1 : ILTP v1.1.2
% Domain   : Constructive Geometry
% Problem  : Theorem 5.8 (Ordered Geometry)
% Version  : [P98] axioms.
% English  : 
...
fof(con,conjecture,(
! [A,B,C,D,L,M] : ((lapt(A,L) & lapt(A,M) & lapt(B,rev(L)) & lapt(B,rev(M)) & lapt(C,L) & lapt(C,rev(M)) & lapt(D,rev(L)) & lapt(D,M)) => con(L,M)))).
