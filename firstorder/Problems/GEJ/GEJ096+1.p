%--------------------------------------------------------------------------
% File     : GEJ096+1 : ILTP v1.1.2
% Domain   : Constructive Geometry
% Problem  : Theorem 6.7 (Ordered Geometry)
% Version  : [P98] axioms.
% English  : 
...
fof(con,conjecture,(
! [L,M,N,A,B,C] : ((bet(L,A,B,C) & con(L,M) & con(L,N) & con(M,N)) => bet(M,pt(M,par(N,A)),pt(M,par(N,B)),pt(M,par(N,C)))))).
